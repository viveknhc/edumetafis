...
<!-- Modal -->
<!-- <div class="modal fade" id="eventJoinNow" tabindex="-1" aria-labelledby="eventJoinNow" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body">
                <form action="" class="event-join-form">
                    <div class="row">
                        <div class="col-lg-6 mb-3">
                            <input type="text  mb-3" placeholder="Name" name="" id="">
                        </div>
                        <div class="col-lg-6  mb-3">
