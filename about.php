...
<section>
    <div class="testimonial">
        ...
        <div class="container">
            <div class="row">
                <div class="owl-carousel owl-loaded owl-drag" id="testimonial-carousel">
                    ...
                    <div class="owl-nav"><button type="button" role="presentation" class="owl-prev"><i
                                class="fa fa-thin fa-arrow-left fa-2x"></i></button><button type="button"
                            role="presentation" class="owl-next"><i
                                class="fa fa-thin fa-arrow-right fa-2x"></i></button></div>
