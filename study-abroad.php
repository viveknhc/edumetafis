...
<section class="career-path-box section">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div>
                    <div class="heading-box">
                        <h5 class="section-top-head">abroad</h5>
                        <h2 class="section-head">studies profiling</h2>
                    </div>
                    <p>
                        Navigate the intricate world of international education seamlessly with our comprehensive abroad
                        studies profiling and application process spanning over 22 countries. </p>
                    <p> Streamline your
                        application journey across 1500+ esteemed universities worldwide, all within just 15 minutes.
